using Newtonsoft.Json; //NuGet Packet Newtonsoft.Json herunterladen!
using System;
...
namespace Json_Tutorial
{
    internal class Program
    {
        ...
        {
            JsonSerializerSettings options = new JsonSerializerSettings();              //Optionen erstellen
            options.Formatting = Formatting.Indented;                                   //Option für "schöne" (mehrzeilige) Schreibweise
            string json = JsonConvert.SerializeObject(Object, typeof(Object), options); //Object zu (Json) String convertieren
        ...
        public static Config ConfigReader(string path)
        {
            ...
            return JsonConvert.DeserializeObject<Config>(json);                         //string 'json' zu Config object konvertieren und zurückgeben
        }
